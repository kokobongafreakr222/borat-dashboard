...
const projects: Project[] = [
  {
    id: 1,
    name: "Чётко-бот",
    description: "Генератор ТЗ для фрилансеров на Gemini Flash 2.5 Lite",
    status: "active",
    github: "kokobongafreakr222/chetko-bot",
    tech: ["Python", "aiogram", "Gemini", "Railway"],
    lastUpdate: "2026-03-11",
  },
  {
    id: 2,
    name: "task-cli",
    description: "CLI менеджер задач с фильтрацией и статистикой",
    status: "active",
  ...
  },
  {
    ...
    description: "Генератор структуры проектов с шаблонами",
    status: "active",
  ...
  {
    id: 4,
    name: "borat-dashboard",
    description: "Веб-дашборд для отслеживания проектов",
    status: "active",
    github: "kokobongafreakr222/borat-dashboard",
